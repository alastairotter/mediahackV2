...
<form action="//mediahack.us14.list-manage.com/subscribe/post?u=60987a40b2618a54d919bccdb&amp;id=b574a151c8" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
	...
	<label class="sub-label" for="mce-EMAIL">Subscribe to our weekly journalism newsletter</label>
    ...
    <div class="front-sub-one-sub">It's free, every Wednesday. <a href="http://mediapicks.mediahack.co.za">Try a copy</a></div>
<style>
    #mc-embedded-subscribe {
        background: #66d4e2 !important;
        color: #fff !important;
